		...
		public UnityEngine.UI.Button E_SendVerificationButton
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_SendVerificationButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"E_EMail/E_SendVerification");
     			}
		...
		public UnityEngine.UI.Image E_SendVerificationImage
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_SendVerificationImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"E_EMail/E_SendVerification");
     			}
		...
		public UnityEngine.UI.Text E_CountdownText
     	{
     		get
     		{
     			...
     			{
		    		this.m_E_CountdownText = UIFindHelper.FindDeepChild<UnityEngine.UI.Text>(this.uiTransform.gameObject,"E_EMail/E_SendVerification/E_Countdown");
     			}
